...
DROP TABLE IF EXISTS movies; # удалить таблицу если она существует
CREATE TABLE movies
(
...
-- добавим столбец с значением по умолчанием и столбец после года создания 
SELECT * FROM cinema;
...
SHOW CREATE TABLE cinema; -- тут можно посмотреть название ключа
ALTER TABLE cinema
